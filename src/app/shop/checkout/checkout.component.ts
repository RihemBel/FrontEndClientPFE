...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    this.checkoutForm = this.fb.group({
      firstname: [ {value: '', disabled: true}, [Validators.required, Validators.pattern('[a-zA-Z][a-zA-Z ]+[a-zA-Z]$')]],
      lastname: [{value: '', disabled: true}, [Validators.required, Validators.pattern('[a-zA-Z][a-zA-Z ]+[a-zA-Z]$')]],
...
// save order
    createOrder() {
        this.orderService.createOrder(this.products, this.checkoutForm.value, '', this.getTotal);
    }
